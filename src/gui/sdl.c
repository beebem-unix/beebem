...
/* Rendering scale (1 = 100%, 0.5 = 50%)
 */
void EG_Draw_SetToLowResolution(void) { scale = 0.5; }

void EG_Draw_SetToHighResolution(void) { scale = 1.0; }

/* Get scale (divide coordinates by this value to calculate the actual size
 * of anything physically drawn on the surface).
 */
float EG_Draw_GetScale(void) { return (scale); }

Uint32 EG_Draw_GetCurrentTime(void) { return (SDL_GetTicks()); }
 ...
 */
static void EG_Draw_UpdateSurfaceAbsolute(SDL_Surface *surface, Sint32 x,
...
void EG_Draw_Disable_Update(void) { no_update = EG_TRUE; }

void EG_Draw_Enable_Update(void) { no_update = EG_FALSE; }

/* Text functions */
static SDL_Surface *label_low = NULL, *label_high = NULL;

static EG_BOOL EG_DrawString_Initialise(void) { // int i;
  char largefont[1024];
  char smallfont[1024];
...
void EG_Draw_Box(SDL_Surface *surface, SDL_Rect *area, SDL_Color *color) {
  ...
  SDL_FillRect(surface, &drawing_area,
...
void EG_Draw_TabBorder(SDL_Surface *surface, SDL_Rect *area, SDL_Color *color,
  ...
  case EG_Draw_Border_Normal:
    bright_col = SDL_MapRGB(surface->format, (Uint8)color->r, (Uint8)color->g,
                            (Uint8)color->b);
  ...
  case EG_Draw_Border_BoxHigh:
    ...
    dull_col = SDL_MapRGB(surface->format, (int)(color->r * 0.6666),
  ...
  case EG_Draw_Border_Focused:
    ...
    dull_col = SDL_MapRGB(surface->format, (int)(color->r * 0.4),
                          (int)(color->g * 0.4), (int)(color->b * 0.4));
...
void EG_Draw_Border(SDL_Surface *surface, SDL_Rect *area, SDL_Color *color,
  ...
  case EG_Draw_Border_Focused:
    dull_col = SDL_MapRGB(surface->format, (int)(color->r * 0.7),
                          (int)(color->g * 0.7), (int)(color->b * 0.7));
