...
bool cRegistry::GetStringValue(HKEY hKeyRoot, const LPCSTR lpSubKey, LPCSTR lpValue, LPSTR lpBuffer)
{
//+>
	// hKeyRoot = User
	// lpSubKey = Application ("Software\BeebEm")
...
bool cRegistry::SetBinaryValue(HKEY hKeyRoot, LPCSTR lpSubKey, LPCSTR lpValue, PVOID pData, int* pnSize)
{
//+>
	// hKeyRoot = User
	// lpSubKey = Application ("Software\BeebEm")
