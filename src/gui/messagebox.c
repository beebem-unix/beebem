...
static const char *FormatText(const char *source_ptr, char *next_row_ptr) {
   ...
   */
  for (i = word_end = 0; i < MSGBOX_MAX_COLS - 1 && i < strlen(source_ptr);
       i++) {
    if (source_ptr[i] == 10) {
      word_end = i;
...
int EG_MessageBox(SDL_Surface *surface_ptr, int type, const char *title_ptr,
  ...
  widget_ptr =
      EG_Label_Create("lab_msgbox", col, EG_LABEL_ALIGN_CENTER, title_ptr, loc);
  ...
  while (strlen(message_ptr) > 0 && row < 24) {
    ...
    widget_ptr =
        EG_Label_Create(NULL, col, EG_LABEL_ALIGN_CENTER, next_row_ptr, loc);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
  ...
  if (button4_ptr != NULL) {
    ...
    widget_ptr =
        EG_Button_Create("4", col, EG_BUTTON_ALIGN_CENTER, button4_ptr, loc);
  ...
  if (button3_ptr != NULL) {
    ...
    widget_ptr =
        EG_Button_Create("3", col, EG_BUTTON_ALIGN_CENTER, button3_ptr, loc);
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, MsgBox_Button_Press,
                                          NULL);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
  ...
  if (button2_ptr != NULL) {
    ...
    widget_ptr =
        EG_Button_Create("2", col, EG_BUTTON_ALIGN_CENTER, button2_ptr, loc);
    (void)EG_Button_SetMyCallback_OnClick(widget_ptr, MsgBox_Button_Press,
                                          NULL);
    (void)EG_Window_AddWidget(window_ptr, widget_ptr);
    if (has_focus == 2)
  ...
  if (button1_ptr == NULL) {
    ...
    widget_ptr =
        EG_Button_Create("1", col, EG_BUTTON_ALIGN_CENTER, button1_ptr, loc);
  }
