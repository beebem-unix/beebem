...
static const unsigned char partab[256] = {
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 0, 4, 4, 0, 4, 0, 0, 4,
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 4, 0, 0, 4, 0, 4, 4, 0,
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 0, 4, 4, 0, 4, 0, 0, 4,
    4, 0, 0, 4, 0, 4, 4, 0, 4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4,
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 0, 4, 4, 0, 4, 0, 0, 4,
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 4, 0, 0, 4, 0, 4, 4, 0,
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 4, 0, 0, 4, 0, 4, 4, 0,
    0, 4, 4, 0, 4, 0, 0, 4, 0, 4, 4, 0, 4, 0, 0, 4, 4, 0, 0, 4, 0, 4, 4, 0,
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 0, 4, 4, 0, 4, 0, 0, 4,
    4, 0, 0, 4, 0, 4, 4, 0, 0, 4, 4, 0, 4, 0, 0, 4, 4, 0, 0, 4, 0, 4, 4, 0,
...
simz80(FASTREG PC) {
  ...
  case 0x1F: /* RRA */
    ...
    sum = temp >> 1;
    AF =
        ((AF & 1) << 15) | (sum << 8) | (sum & 0x28) | (AF & 0xc4) | (temp & 1);
    break;
  case 0x20: /* JR NZ,dd */
  ...
  case 0x80: /* ADD A,B */
    ...
    sum = acu + temp;
    cbits = acu ^ temp ^ sum;
    AF = ((sum & 0xff) << 8) | (sum & 0xa8) | (((sum & 0xff) == 0) << 6) |
  ...
  case 0xB8: /* CP B */
    ...
    sum = acu - temp;
    cbits = acu ^ temp ^ sum;
    AF = (AF & ~0xff) | (sum & 0x80) | (((sum & 0xff) == 0) << 6) |
  ...
  case 0xCB: /* CB prefix */
    ...
    case 0x00: /* shift/rotate */
      ...
      case 0x38: /* SRL */
        ...
        cbits = acu & 1;
      cbshflg1:
        AF = (AF & ~0xff) | (temp & 0xa8) | (((temp & 0xff) == 0) << 6) |
             parity(temp) | !!cbits;
      }
      break;
    case 0x40: /* BIT */
  ...
  case 0xED: /* ED prefix */
    ...
    case 0xA1: /* CPI */
      ...
      AF = (AF & ~0xfe) | (sum & 0x80) | (!(sum & 0xff) << 6) |
           ...
           ((sum - ((cbits >> 4) & 1)) & 8) | ((--BC & 0xffff) != 0) << 2 | 2;
