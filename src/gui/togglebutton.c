...
static EG_BOOL Callback_Paint(EG_Widget *widget_ptr, SDL_Rect area) {
  ...
  if (EG_Shared_GetRenderingDetails(widget_ptr, area, (void *)&togglebutton_ptr,
...
static EG_BOOL Callback_SDL_Event(EG_Widget *widget_ptr, SDL_Event *event_ptr) {
  ...
  if (EG_Shared_GetEventDetails(widget_ptr, event_ptr,
                                (void *)&togglebutton_ptr, &window_ptr,
  ...
  if (event_ptr->type == SDL_MOUSEBUTTONDOWN ||
     ...
     */
    if (togglebutton_ptr->depressed == EG_FALSE &&
...
static void InitializeWidget(EG_Widget *widget_ptr, SDL_Color color,
                             SDL_Rect dimension, const char *caption_ptr) {
...
EG_Widget *EG_ToggleButton_Create(const char *name_ptr, SDL_Color color,
  ...
  SHARED__CREATE_NEW_EG_WIDGET(widget_ptr, name_ptr,
                               EG_Widget_Type_ToggleButton, togglebutton_ptr);
...
EG_BOOL EG_ToggleButton_SetCaption(EG_Widget *widget_ptr,
...
EG_BOOL EG_ToggleButton_SetGroupParent(EG_Widget *togglebutton_widget_ptr,
  ...
  EG_TOGGLEBUTTON_GET_STRUCT_PTR(togglebutton_widget_ptr, togglebutton_ptr,
                                 EG_FALSE);
