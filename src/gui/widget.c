...
EG_BOOL
EG_Widget_SetCallback_SDL_Event(EG_Widget *widget_ptr,
...
EG_BOOL
EG_Widget_SetCallback_GotFocus(EG_Widget *widget_ptr,
...
EG_BOOL
EG_Widget_SetCallback_LostFocus(EG_Widget *widget_ptr,
...
EG_BOOL
EG_Widget_SetUserCallback_OnChange(EG_Widget *widget_ptr,
...
EG_BOOL
EG_Widget_SetUserCallback_OnClick(EG_Widget *widget_ptr,
...
EG_BOOL
EG_Widget_SetUserCallback_OnEvent(EG_Widget *widget_ptr,
...
EG_BOOL EG_Widget_SetUserCallback_OnLostFocus(
    EG_Widget *widget_ptr, EG_Callback_User_OnLostFocus user_callback_ptr,
    void *user_event_value_ptr) {
  CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);
...
EG_BOOL EG_Widget_SetUserCallback_OnGotFocus(
    EG_Widget *widget_ptr, EG_Callback_User_OnGotFocus user_callback_ptr,
    void *user_event_value_ptr) {
  CHECK_EG_WIDGET_IS_VALID(widget_ptr, EG_FALSE);
...
EG_BOOL EG_Widget_SetValue_String(EG_Widget *widget_ptr,
