...
EG_Widget *EG_ToggleButton_Create(const char *name_ptr, SDL_Color color,
                                  const char *caption_ptr, SDL_Rect dimention);
...
#define EG_ToggleButton_ClearMyCallback_OnEvent                                \
  EG_Widget_ClearUserCallback_OnEvent

#define EG_ToggleButton_SetMyCallback_OnClick EG_Widget_SetUserCallback_OnClick
#define EG_ToggleButton_ClearMyCallback_OnClick                                \
  EG_Widget_ClearUserCallback_OnClick
