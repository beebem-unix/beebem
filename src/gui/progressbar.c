...
static EG_BOOL Callback_Paint(EG_Widget *widget_ptr, SDL_Rect area) {
  ...
  if (EG_Shared_GetRenderingDetails(widget_ptr, area, (void *)&progressbar_ptr,
...
static EG_BOOL InitializeWidget(EG_Widget *widget_ptr, SDL_Color color,
                                SDL_Color bar_color, SDL_Rect dimension) {
...
EG_Widget *EG_ProgressBar_Create(const char *name_ptr, SDL_Color color,
                                 SDL_Color bar_color, SDL_Rect dimension) {
  EG_ProgressBar *progressbar_ptr;
