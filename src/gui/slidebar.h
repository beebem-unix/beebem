...
#define EG_SlideBar_ClearMyCallback_OnChange                                   \
  EG_Widget_ClearUserCallback_OnChange

#define EG_SlideBar_SetMyCallback_OnLostFocus                                  \
  EG_Widget_SetUserCallback_OnLostFocus
#define EG_SlideBar_ClearMyCallback_OnLostFocus                                \
  EG_Widget_ClearUserCallback_OnLostFocus

#define EG_SlideBar_SetMyCallback_OnGotFocus                                   \
  EG_Widget_SetUserCallback_OnGotFocus
#define EG_SlideBar_ClearMyCallback_OnGotFocus                                 \
  EG_Widget_ClearUserCallback_OnGotFocus
