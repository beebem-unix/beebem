...
int Z80_Disassemble(int adr, char *s) {
  ...
  static STR arith[8] = {"ADD\tA,", "ADC\tA,", "SUB\t", "SBC\tA,",
                         "AND\t",   "XOR\t",   "OR\t",  "CP\t"};
  ...
  case 0x00:
    ...
    case 0x01:
      if (a & 0x08) {
        ...
        strcat(s, ",");
        sprintf(stemp, "%4.4Xh",
                ReadZ80Mem(adr + 1) + (ReadZ80Mem(adr + 2) << 8));
        strcat(s, stemp);
        size = 3;
      }
      break;
    ...
    case 0x06: // LD	d,n
      ...
      break;
    case 0x07: {
      static STR str[8] = {"RLCA", "RRCA", "RLA", "RRA",
                           "DAA",  "CPL",  "SCF", "CCF"};
      strcpy(s, str[d]);
    } break;
    }
  ...
  case 0xC0:
    ...
    case 0x03:
      ...
      case 0x01:               // 0xCB
        ...
        switch (a & 0xC0) {
        case 0x00: {
          static STR str[8] = {"RLC", "RRC", "RL",  "RR",
                               "SLA", "SRA", "???", "SRL"};
          strcpy(s, str[d]);
        }
          strcat(s, "\t");
        ...
        case 0x02:               // 0xED
          ...
          case 0x40:
            ...
            case 0x06:
              ...
              break;
            case 0x07: {
              static STR str[8] = {"LD\tI,A", "???", "LD\tA,I", "???",
                                   "RRD",     "RLD", "???",     "???"};
              strcpy(s, str[d]);
            } break;
            }
